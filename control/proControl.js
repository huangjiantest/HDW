var proControl = function(){};

proControl.prototype.proList = function(req,res,next){
...
proControl.prototype.proAdd = function(req,res,next){
	var ep = new EventProxy();
...
proControl.prototype.proDel= function(req,res,next){
	var ep = new EventProxy();
	dataSource.getConn(ep);
